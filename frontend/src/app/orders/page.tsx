    ...
    <div className="bg-white/90 shadow-xl rounded-2xl p-6 mb-6 border border-blue-100 hover:shadow-2xl transition-all group relative overflow-hidden">
      ...
      <div className="flex flex-wrap gap-4 items-center mb-2">
        ...
        <span className="text-gray-700 font-medium">
          Total: <span className="text-blue-700">${order.total_price.toFixed(2)}</span>
        </span>
      </div>
      <div className="mt-2 space-y-1">
        ...
        {order.items && order.items.length > 2 && (
          <div className="text-xs text-gray-400 italic">+ {order.items.length - 2} more items</div>
        )}
      </div>
      <button
  ...
  return (
    <div className="container mx-auto px-4 py-10 max-w-3xl">
      ...
      <div className="bg-white/90 rounded-xl shadow p-6 mb-10 border border-blue-100 flex flex-wrap gap-4 items-end justify-between">
        ...
        <button
          onClick={resetFilter}
          className="ml-auto mt-2 bg-gray-100 hover:bg-gray-200 text-gray-600 px-3 py-2 rounded-lg flex items-center gap-2 border border-gray-200 transition"
        >
          <FaTimes /> Reset
        </button>
      </div>
        ...
        <div className="space-y-6">
          {filteredOrders && filteredOrders.length > 0 ? (
            ...
            <div className="text-gray-500 text-center py-10">
              <FaSearch className="mx-auto mb-2 text-3xl" />
